...
Read [AGENTS.md](../AGENTS.md) for the personality, always-on rules, skill routing, workflow,
commands, and security policy. Do not add guidance here — put it in `AGENTS.md` so every client
sees it.
