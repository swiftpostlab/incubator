...
- Did you add `.agents/playground/`, `.agents/tasks/`, and `.agents/retro/` to both Git ignore rules and the AI exclusion policy?
...
- Did you put the real guidance in a root `AGENTS.md` and reduce `.claude/CLAUDE.md`, `GEMINI.md`, and `.github/copilot-instructions.md` to thin bridges pointing at it?
